...
for await (const line of console) {
  ...
  const fileName = `${date.getUTCFullYear()}_${addZero(date.getUTCMonth()+1)}_${addZero(date.getUTCDate())}_${addZero(date.getUTCHours())}${addZero(date.getUTCMinutes())}${addZero(date.getUTCSeconds())}_${line}`
